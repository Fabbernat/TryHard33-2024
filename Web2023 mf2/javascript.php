...
<head>
    <meta charset="UTF-8">
    <title> TryHard - Javascript Tutorial</title>
...
<nav>
    ...
    <a class="nav " href="html.php">HTML</a>
    <a class="nav " href="css.php">CSS</a>
    <a class="nav current_page" href="javascript.php">JAVASCRIPT</a>
    <a class="nav " href="php.php">PHP</a>
    <a class="nav " href="python.php">PYTHON</a>
</nav>
