...
<head>
    <meta charset="UTF-8">
    <title> TryHard - HTML Tutorial</title>
    <link href="css/style.css" rel="stylesheet">
</head>
<body>
<nav>
    <a class="nav "
       href="index.html">Home<i class="yellow"></i></a> |
    <a class="nav "
       href="signup.html">Sign up<i class="yellow"></i></a> |
    <a class="nav "
       href="login.html">Log in<i class="yellow"></i></a> |
    <a class="nav "
       href="profile.html">Profile<i class="yellow"></i></a>
    <a class="nav "
       href="progress.html">Progress <i class="yellow"></i></a>

    <a class="nav "
       href="feedback.html">Feedback <i class="yellow"></i></a>
    <a class="nav "
       href="admin.html">Admin <i class="yellow"></i></a>

</nav>
<nav>
    <h1 class="choose-a-lesson-to-learn">Choose a lesson to learn:</h1>
    <a class="nav current_page" href="html.html">HTML</a>
    <a class="nav " href="css.html">CSS</a>
    <a class="nav " href="javascript.html">JAVASCRIPT</a>
    <a class="nav " href="php.html">PHP</a>
    <a class="nav " href="python.html">PYTHON</a>
</nav>
...
<main class="lesson-container white left-align">
    ...
    <div id="introduction">
        <div class="html-intro">
            ...
            <p>With HTML you can create your own Website.</p>
            <p>HTML is easy to learn - You will enjoy it!</p>
            <img alt="image of a website demonstrating h1 and p tags" src="img/img_chrome.png">
            <hr>
            <h3 class="darkcyan">Why Learn HTML?</h3>
            <p>Learning HTML is essential for anyone interested in web development. It serves as the foundation for
                creating web pages and understanding how content is structured on the internet.</p>
    ...
    <section class="html-intro" id="basics">
        <hr>
        <h2 class="darkcyan">HTML Basics</h2>
        <p>HTML consists of a series of elements that define the structure of a webpage.</p>
        <h3>Key Concepts:</h3>
        <ul>
            <li><strong>Elements:</strong> HTML documents are made up of elements, which are the building blocks of a webpage.
                Each element consists of a start tag, content, and an end tag.
            </li>
            <li><strong>Tags:</strong> Tags are used to mark up the start and end of an element. They are enclosed in angle
                brackets (<code>&lt;</code> and <code>&gt;</code>), and most tags come in pairs (start and end tags).
            </li>
            <li><strong>Attributes:</strong> Attributes provide additional information about an element and are added to the
                start tag. They are made up of a name and a value and are written as name-value pairs, e.g., <code>class="example"</code>.
            </li>
            <li><strong>Document Structure:</strong> HTML documents typically consist of an <code>&lt;html&gt;</code> element
                that contains <code>&lt;head&gt;</code> and <code>&lt;body&gt;</code> elements. The <code>&lt;head&gt;</code>
                element contains metadata, such as the page title and links to stylesheets, while the <code>&lt;body&gt;</code>
                element contains the main content of the page.
            </li>
        </ul>

        <h3>Basic HTML Skeleton:</h3>
...
&lt;/html&gt;
        ...
        <ul>
            <li><code>&lt;div&gt;</code>: Defines a division or section of the document.</li>
            <li><code>&lt;p&gt;</code>: Defines a paragraph.</li>
            <li><code>&lt;h1&gt;</code> to <code>&lt;h6&gt;</code>: Heading elements, with <code>&lt;h1&gt;</code> being the
                highest level and <code>&lt;h6&gt;</code> the lowest.
            </li>
            <li><code>&lt;a&gt;</code>: Defines a hyperlink.</li>
            <li><code>&lt;img&gt;</code>: Embeds an image into the page.</li>
            <li><code>&lt;ul&gt;</code> and <code>&lt;ol&gt;</code>: Defines unordered and ordered lists, respectively.</li>
            ...
            <li><code>&lt;input&gt;</code>: Defines an input control within a form.</li>
        </ul>
...
&lt;/html&gt;
        ...
        <p>By mastering the basics of HTML, you'll be able to create well-structured and semantically meaningful web
            pages.</p>
    </section>

    <section class="html-intro" id="elements">
        <hr>
        <h2 class="darkcyan">HTML Elements</h2>
        <p>HTML elements are the building blocks of HTML pages.</p>
        <article>
            ...
            <p>
                Semantic HTML elements provide valuable information about the role of each section in the webpage,
                aiding search engines and web crawlers in understanding the content structure. Elements like <code>&lt;header&gt;</code>,
                <code>&lt;footer&gt;</code>, <code>&lt;nav&gt;</code>, <code>&lt;article&gt;</code>,
                <code>&lt;section&gt;</code>,
                and <code>&lt;aside&gt;</code> convey semantic meaning.
            </p>
            <h3>Block vs. Inline Elements</h3>
            ...
            <h3>Common HTML Elements</h3>
            <p>
                Standard HTML elements serve various purposes, including headings (<code>&lt;h1&gt;</code> to
                <code>&lt;h6&gt;</code>),
                paragraphs (<code>&lt;p&gt;</code>), links (<code>&lt;a&gt;</code>), images
                (<code>&lt;img&gt;</code>), lists (<code>&lt;ul&gt;</code>, <code>&lt;ol&gt;</code>, <code>&lt;li&gt;</code>),
                forms (<code>&lt;form&gt;</code>, <code>&lt;input&gt;</code>, <code>&lt;button&gt;</code>), tables (<code>&lt;table&gt;</code>,
            ...
            <div class="reset-this-root">
                <div class="show">
                    <h1 class="h1-demo">This is what a h1 heading looks like</h1>
                    <h2>This is what a h2 heading looks like</h2>
                    <h3>This is what a h3 heading looks like</h3>
                    <h4>This is what a h4 heading looks like</h4>
                    <h5>This is what a h5 heading looks like</h5>
...
&lt;p&gt;This is what a paragraph looks like&lt;/p&gt;</pre>
    ...
    <section class="html-intro" id="attributes">
        <hr>
        <h2 class="darkcyan">HTML Attributes</h2>
        <p>HTML attributes provide additional information about HTML elements.</p>
        <!-- more content for HTML attributes -->
    ...
    <div>
        ...
        <br>
        <a class="left btn" href="html.html">&#10094; Previous</a>
        <a class="right btn" href="css.html">Next &#10095;</a>
    </div>
</main>
<footer>
    <section>
        <h2>Contact us:</h2>
        <ul>
            <li><a href="mailto:meowuwuka@calculus.hu">meowuwuka@calculus.hu</a></li>
            <li><a href="https://www.facebook.com/meowuwuka">facebook.com/meowuwuka</a></li>
            <li><a href="https://www.linkedin.com/in/meowuwuka">linkedin.com/meowuwuka</a></li>
            <li><a href="https://www.instagram.com/meowuwuka">instagram.com/meowuwuka</a></li>
        </ul>
